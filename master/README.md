...
```json
{
    // Hotel is identified by name. The name of the file is the same as the hotel's.
    "Pergamos": {
        "name": "Pergamos",
        // Rooms are described by an array so that it can be parsed easier by the library.
        "rooms":[ 
            {
